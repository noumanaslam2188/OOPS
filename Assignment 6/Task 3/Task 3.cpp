...
public:
	...
	{
		fstream myfile("data_in.txt");
		myfile << "Enter the pages of Book" << endl;
		myfile >> page_count;
	}
	void put_data()
	{
		fstream myfile("data_out.txt");
		myfile << "Pages of Book : " << page_count;
	}
};
...
public:
	...
	{
		fstream myfile("data_in.txt");
		myfile << "Enter the playing time in minutes " << endl;
		myfile >> playing_mins;
	}
	void put_data()
	{
		fstream myfile("data_out.txt");
		myfile << "Playing time in minutes : " << playing_mins << endl;
	}
};
